...
class ESVDSpecific():
    ...
    correct_categories = {
        ...
        # Broken auth
        'CWE256': [],
        'CWE259': ['Security Misconfiguration'],
        'CWE321': [],
        'CWE523': [],
        'CWE549': [],
